...
const routes = [
  ...
  { path: '/resident/activity-review', name: 'ResidentActivityReview', component: () => import('../views/ResidentActivityReview.vue'), meta: { requiresAuth: true, role: 'property_admin' } },
  { path: '/resident/activity-detail/:id', name: 'ResidentActivityReviewDetail', component: () => import('../views/ResidentActivityReviewDetail.vue'), meta: { requiresAuth: true, role: 'resident' } },
